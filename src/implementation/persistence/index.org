...
***** Test getAll: Nil --> set[Role]
 #+BEGIN_SRC python :tangle ../../tests/test_db.py :eval no
    def test_role_get_all(self):
        ...
        system = setUp()
        boo = Role.get_all_roles() == ['admin','user']
        self.assertTrue(boo)
        tearDown(system)
...
class TestSession(TestCase)
    ...
    def create_app(self):
        ...
        return app
 #ADDED  
    def test_session_creation(TestCase)
        print "test_session_creation"
        system=setUp()
        self.assertEqual(system.users[0].role.value,'admin')
...
#ADDED
        ...
        system = setUp()
        usr=system.get_user()
        self.assertEquals(user.name.value,'shashank')
        system = tearDown(system)
#+END_SRC
...
**** test_set_user
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
    def test_set_user(self,user):
    #ADDED
        print "test_set_user"
        system = setUp()
        sess2=system.create_user(sess,'srivalya','srivalya@gmail.com',Role.get_by_id(2))
        sess2.set_user(None)
        self.assertEquals(sess2.get_user(),None)
...
**** test_admin_check
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
    def test_admin_check(self,user):
    #ADDED
       print "test_admin_check"
       system=setUp()
       #shashank is an admin
       self.assertTrue(system.admin_check(system.users[0]))
       system.create_user(sess,'messi','messi@gmail.com',Role.get_by_id(2))
       #is not an admin
       self.assertFalse(system.admin_check(system.get_user_from_email('messi@gmail.com'))
       system = tearDown(system)
#+END_SRC
